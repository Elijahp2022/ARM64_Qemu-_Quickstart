...
If you didn't setup the internet connection earlier(or you did but it didn't take) We can do that now by going into editing '''/etc/netpan/xx-cloud-init.yaml'''
